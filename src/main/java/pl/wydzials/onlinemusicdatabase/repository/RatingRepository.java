...
public interface RatingRepository extends JpaRepository<Rating, Long> {
  ...
  @Query("select r from Rating r where r.user.username = :username and r.entity = :entity")
  Optional<Rating> findByUsernameAndEntity(String username, RateableEntity entity);
}
